...
module.exports = {
    // ===== BOT CORE SETTINGS =====
    SESSION_ID: process.env.SESSION_ID || "",  // SUBZERO-MD~k9jrbSD156WpdpOVl2Td
    ...
    OWNER_NUMBER: process.env.OWNER_NUMBER || "263719647303",  // +94758728028
    OWNER_NAME: process.env.OWNER_NAME || getConfig("OWNER_NAME") || "chathuka dinujaya",           // Owner's name
